    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chief', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='exers', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expired_at', models.DateTimeField(default=datetime.datetime(2024, 7, 25, 11, 42, 56, 762860))),
                ('is_used', models.BooleanField(default=False)),
                ('inviter', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='invitations', to=settings.AUTH_USER_MODEL)),
            ],
            options={
